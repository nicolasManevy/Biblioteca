...
namespace TallerBiblioteca.Infrastructure.Seguridad
{
    public class HashingManager : IHashingManager
    {
        ...
        public string Hash(string password, int iterations = DefaultIterations)
        {
            ...
            using (var rng = new RNGCryptoServiceProvider())
            {
                ...
                using (var pbkdf2 = new Rfc2898DeriveBytes(password, salt, iterations))
                {
                    ...
                    return $"$BBTK-V1${iterations}${base64Hash}";
                }
            }
        ...
        {
            return hashString.Contains("$BBTK-V1$");
        }
        ...
        public bool Verify(string password, string hashedPassword)
        {
            ...
            var splittedHashString = hashedPassword.Replace("$BBTK-V1$", "").Split('$');
